...
И ее описание.
![Снимок экрана 2024-03-09 в 10.21.00](https://github.com/srapchegs/rtippo/assets/160636893/9de55fa7-3dd6-4d1e-a839-d6d7173bfdfb)
...
| Описание                 | Игрок не вводит свое имя, игра продолжается без персонализации. |
| Предусловия              | Игра не начата.                                          |
| Постусловия              | Система продолжает выполнение без сохранения имени игрока. |
...
| Прецедент                    | Запоминание предметов                                    |
|------------------------------|----------------------------------------------------------|
| Название                 | Запоминание предметов                                    |
| Рамки                    | Разрабатываемая система                                   |
| Уровень                  | Задача определена пользователем                           |
| Основной исполнитель     | Игроки                                                   |
| Заинтересованные лица и их требования | Игроки должны запомнить предметы, расставленные на столе, в течение 3 минут. |
| Предусловия              | Таймер запущен.                                          |
| Постусловия              | Время истекло, игроки должны отворачиваться от стола.   |
| Основной сценарий        | 1. Игроки видят предметы на столе.                      |
|                              | 2. Таймер идет.                                          |
|                              | 3. Игроки запоминают предметы на столе.                |
| Альтернатива            | Игроки не успевают запомнить предметы.                  |
| Описание                 | Игроки не могут запомнить все предметы в течение отведенного времени. |
| Предусловия              | Таймер запущен, игроки смотрят на предметы.             |
| Постусловия              | Время истекло, игроки отворачиваются от стола.         |
